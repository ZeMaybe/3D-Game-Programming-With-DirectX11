...
bool TreeBillboardApp::Init(HINSTANCE hinst)
{
	...
	HR(CreateWICTextureFromFile(md3dDevice, L"../Textures/WireFence.dds", &res, &mBoxMapSRV));
	ReleaseCOM(res);
...
void TreeBillboardApp::DrawScene()
{
	...
	md3dImmediateContext->IASetInputLayout(mInputLayout01);
	...
	for (UINT p = 0; p < techDesc.Passes; ++p)
	{
		...
		mEffect01->SetDiffuseMap(mBoxMapSRV);
...
void TreeBillboardApp::BuildTreeSpritesBuffer()
{
	...
	for (UINT i = 0; i < TreeCount; ++i)
	{
		...
		// Move tree slightly above land height.  树的中间点会比山坡高
		y += 10.0f;
